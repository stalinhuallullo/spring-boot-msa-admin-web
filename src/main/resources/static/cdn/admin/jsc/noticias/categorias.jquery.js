...
$(document).ready(function() {
	...
	tbl_category = $('#lista-categorias').DataTable({
        ...
        'ajax': {
            'url': API.NOTICIAS + 'categoria/filter',
        ...
        'columns': [{
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    //console.log(row);
                    return '<button type="button" class="btn-shadow btn-eliminar-categoria btn btn-danger"><i class="fa fa-times-circle fa-w-20"></i></button> <button type="button" class="btn-editar btn-shadow btn btn-primary" data-toggle="modal"><i class="fa fa-edit fa-w-20"></i></button>';
                },
                "orderable": false
            },
        ],
...
$( "#form-categoria #nombre" ).keyup(function( e ) {
    ...
    $('body').on('click', '.btn-editar', function() {
        ...
        loadOn(el);
        $.get(API.NOTICIAS + "categoria/" + $(el).parents('tr').attr('id'), function(rpta) {
            $('div.form-categoria-modal').modal('show');
            ...
            buttons: {
                aceptar: {
                    ...
                    action: function() {
                        ...
                        $.ajax({
                            url: API.NOTICIAS + 'categoria/'+$(el).parents('tr').attr('id'),
                            type: 'DELETE',
                            success: function(rpta) {
                            	tbl_category.ajax.reload(null, false);
                                $.toast({
